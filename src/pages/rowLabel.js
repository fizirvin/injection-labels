    ...
    if (this.state.header === "GEN AL5" || this.state.header === "GEN AL6") {
      ...
      return (
        <select
          id="inspector"
          name={_id}
          value={this.props.inspector}
          onChange={this.onInspector}
        >
  ...
  renderRowLabel = ({ index, _id, header, color, text, intRef }) => {
    return (
      <tr key={_id} className="row_label_selected">
        <td className="table_body_row check">
          <input
            type="checkbox"
            value={_id}
        ...
        <td
          className="table_body_row text_row"
        ...
        <td className="table_body_row">{this.renderInspectorSelect(_id)}</td>
        <td className="table_body_row">
          <select
            id="operator"
            name={_id}
        ...
        <td className="table_body_row">
          <Link
            to={`/label/${_id}/${this.state.lot}/${this.state.pieces}/${
              this.props.inspector || "AL"
            }/${this.props.operator}/${this.state.quantity}/${
              this.state.start
            }`}
          >
